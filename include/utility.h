...
class ParamServer {
  public:
    ...
    bool is_extract_large_planes;
    float point_to_plane_thresh;
    int plane_least_inliers;
    bool is_incremental_fitting;
    bool is_point_relative_time_unit_us;
    ...
    ParamServer() {
        ...
        nh.param<bool>("lio_sam/is_extract_large_planes", is_extract_large_planes, false);
        nh.param<float>("lio_sam/point_to_plane_thresh", point_to_plane_thresh, 0);
        nh.param<int>("lio_sam/plane_least_inliers", plane_least_inliers, -1);
        nh.param<bool>("lio_sam/is_incremental_fitting", is_incremental_fitting, false);
        nh.param<bool>("lio_sam/is_point_relative_time_unit_us", is_point_relative_time_unit_us, false);
